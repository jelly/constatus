...
public:
	source_v4l(const std::string & id, const std::string & dev, const bool prefer_jpeg, const bool rpi_workaround, const int jpeg_quality, const double max_fps, const int w_override, const int h_override, resize *const r, const int resize_w, const int resize_h, const int loglevel);
	virtual ~source_v4l();
