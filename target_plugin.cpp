...
void target_plugin::operator()()
{
	...
	for(;!local_stop_flag;) {
		...
		if (!is_open) {
			...
			sp -> open_file(sp -> arg, (store_path + prefix).c_str(), fps, quality);
			is_open = true;
